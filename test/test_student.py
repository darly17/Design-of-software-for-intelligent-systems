...
class TestStudent(unittest.TestCase):
    ...
    def test_choose_theme(self):
        ...
        self.assertEqual(course_project._theme,'Artificial_Intelligence_in_Medicine')
    ...
    def test_analyse(self):
        ...
        self.assertEqual(course_project._text,["Artificial intelligence helps in disease diagnosis by analyzing medical images and patient data for accurate predictions."])
