...
class Student :
    THEME_FILE = Path("data_bases/theme.json")
    INFO_FILE= Path("data_bases/info.json")
    ...
    def edit_plan(self,course_project: Course_project,item_number: str, text: str)->None:
        ...
        #print("plan of work now:",course_project.get_work_plan())
    ...
    def analyse_information(self,course_project: Course_project)->None:
        for article_theme in self._info_for_cp:
            if course_project.get_theme() in article_theme:
